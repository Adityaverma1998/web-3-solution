...
const GetInTouch = () => {
    return (<div id={'get-in-touch'} className={'container'}>

        <div
            className={'my-8 md:my-44 w-full grid grid-cols-1 md:grid-cols-2 p-8 lg:p-18 xl:p-24 md:p-12 contactUsSection'}>
