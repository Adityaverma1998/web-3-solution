...
const ContactUs = () => {
    return (<div className={'overflow-x-hidden'}>
            <div id={'get-in-touch'} className={'bg-[#0D0D0D] border-[1px] border-[#232121] py-4 px-6 rounded-[8px]'}>

                <div
                    className={'mt-8 w-full grid grid-cols-1 md:grid-cols-2  contactUsSection'}>
